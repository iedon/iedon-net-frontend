export default {
  ...
  pages: {
    ...
    nodes: {
      ...
      statusOpen: 'オープン',
      statusOpenManuallyReview: 'オープン（スタッフ審査）', statusClosed: '新規ユーザーはクローズ',
      statusFull: '満員',
      statusCapacity: '容量',
    ...
    peering: {
      ...
      routingPolicyTypes: {
        ...
        PEER: 'ピア',
        PEER_DESC: '自分と下流のルートを送信、あなたと「下流」（AS Path ≤ 2）のルートを受信。',
        DOWNSTREAM: '下流',
        DOWNSTREAM_DESC: 'すべての有効なルートを送信、あなたと「下流」（AS Path ≤ 2）のルートを受信。',
        UPSTREAM: '上流（管理者）',
        UPSTREAM_DESC: 'すべての有効なルートを受信、遠隔に自分と下流のルートを送信。'
      },
