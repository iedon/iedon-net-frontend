export default {
  ...
  pages: {
    ...
    peering: {
      ...
      routingPolicyTypes: {
        FULL: 'フルテーブル',
        FULL_DESC: 'すべての有効なルートを送信・受信します。',
        TRANSIT: 'トランジット',
        TRANSIT_DESC: '自分自身とダウンストリームの有効なルートを送信。すべての有効なルートを受信します。',
        PEER: 'ピア',
        PEER_DESC: '自分自身とダウンストリームの有効なルートを送信。リモート所有の有効なルートとリモートダウンストリームを受信します。',
        DOWNSTREAM: 'ダウンストリーム',
        DOWNSTREAM_DESC: 'すべての有効なルートを送信。リモート所有の有効なルートとリモートダウンストリームを受信します。',
        UPSTREAM: 'アップストリーム（管理者）',
        UPSTREAM_DESC: 'すべての有効なルートを受信。自分自身とダウンストリームのルートをリモートに送信します。'
      },
      openvpn: 'OpenVPNトンネル',
      wireguard: 'WireGuardトンネル',
      ipsec: 'IPSecトンネル',
      gre: 'IPv4上のGREトンネル',
      ip6gre: 'IPv6上のGREトンネル',
      direct: '直接イーサネット',
      'mp-bgp': 'マルチプロトコルBGP',
