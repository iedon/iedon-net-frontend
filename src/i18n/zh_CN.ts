export default {
  ...
  pages: {
    ...
    nodes: {
      ...
      pleaseSignIn: '请先登录。',
      statusOpen: '开放',
      statusOpenManuallyReview: '开放（人工审核）', statusClosed: '新用户关闭',
      statusFull: '已满员',
      statusCapacity: '容量',
      routerOffline: '路由器离线',
    ...
    peering: {
      ...
      routingPolicyTypes: {
        ...
        TRANSIT: '中继',
        TRANSIT_DESC: '发送本地及下游路由，接收所有有效路由。',
        PEER: '对等',
        PEER_DESC: '发送本地及下游路由，接收您的及“下游”（AS Path ≤ 2）路由。',
        DOWNSTREAM: '下游',
        DOWNSTREAM_DESC: '发送所有有效路由，接收您的及“下游”（AS Path ≤ 2）路由。',
        UPSTREAM: '上游（管理员）',
        UPSTREAM_DESC: '接收所有有效路由，向远端发送本地及下游路由。'
      },
