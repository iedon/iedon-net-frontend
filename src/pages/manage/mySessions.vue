...
const handleEnable = (session: Session) => simpleActionHandler(session, 'enable')
const handleDisable = (session: Session) => simpleActionHandler(session, 'disable')
const handleRemove = (session: Session) => simpleActionHandler(session, 'delete')
